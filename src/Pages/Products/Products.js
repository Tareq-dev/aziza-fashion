...
import girl from '../../images/pretty-woman-with-golden-nails-beautiful-gold-jewelry-isolated-white-background (Small).jpg'
...
function Products({ addToCard }) {
    ...
    return (
        <div>
            ...
            <h1 className='text-center md:text-4xl text-2xl font-bold md:pt-10 pt-4'>Our Products</h1>
