...
function ShippingDetailsPreview() {
        ...
        <div className='md:m-20  px-10 py-14 bg-white'>
            ...
            <div>
                ...
                <div className='flex justify-center items-center py-4'>
                    ...
                    <button disabled={!check} onClick={!check ? undefined : handlePayment} className='bg-orange-400 p-2 font-semibold  text-white rounded-md' type="" >
                        Payment
                    </button>
