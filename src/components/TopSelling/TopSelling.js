    ...
    return (
        <div>
            <div className='text-center'>
                <h1 className='text-4xl font-extrabold'>Top Selling Products</h1>
                <p className='text-xl text-center mt-4'>Qui eu deserunt consequat est nulla sunt in enim quis cillum</p>
                <p className='text-xl text-center'> nulla sunt in enim quis cillum. Qui eu deserunt consequat est nulla</p>
            </div>
